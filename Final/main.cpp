...
extern float cpDepanX, cpDepanZ, cpBelakangX, cpBelakangZ;//collision
...
int CollisionRule(Objek objek, int *existance) {
    ...
    oMinX = objek.getX() - (objek.getSize()/2) - 1.5;
    oMaxX = objek.getX() + (objek.getSize()/2) + 1.5;
    oMinZ = objek.getZ() - (objek.getSize()/2) - 1.5;
    oMaxZ = objek.getZ() + (objek.getSize()/2) + 1.5;
...
void display() {
    ...
    if (buildings){
        ...
        //Side 1
		Apartment Apartment11(35, 0,210,20,0.8,0.2,0.1,3);
        CollisionRule(Apartment11, &buildings);
        Apartment Apartment12(40, 0,180,30,0.2,0.9,0.49,1);
        CollisionRule(Apartment12, &buildings);
        Apartment Apartment13(45, 0,140,40,0.1,0.52,0.2,2);
        CollisionRule(Apartment13, &buildings);
		Apartment Apartment14(35, 0,-80,20,0.1,0.5,0.8,3);
        CollisionRule(Apartment14, &buildings);
        Apartment Apartment15(40, 0,-40,30,0.9,0.5,0.9,1);
        CollisionRule(Apartment15, &buildings);
        Apartment Apartment16(45, 0,-0,40,0.49,0.7,0.59,2);
        CollisionRule(Apartment16, &buildings);
        Apartment Apartment17(50, 0,-175,50,0.17,0.70,0.13,2);
        ...
        //Sisi 2
		Apartment Apartment21(50, 0,250,50,0.12,0.3,0.5,1);
        CollisionRule(Apartment21, &buildings);
        Apartment Apartment22(100, 0,260,30,0.2,0.6,0.79,2);
		...
		Apartment Apartment23(290, 0,250,50,0.1,0.23,0.33,1);
        CollisionRule(Apartment23, &buildings);
        Apartment Apartment24(245, 0,260,30,0.9,0.2,0.9,2);
        CollisionRule(Apartment24, &buildings);
		
        //Side 3
		Apartment Apartment31(305, 0,210,20,0.23,0.5,0.9,3);
        CollisionRule(Apartment31, &buildings);
        Apartment Apartment32(300, 0,180,30,0.6,0.4,0.234,1);
        CollisionRule(Apartment32, &buildings);
        Apartment Apartment33(295, 0,140,40,0.3,0.1,0.1,2);
        CollisionRule(Apartment33, &buildings);
		Apartment Apartment34(305, 0,-80,20,0.3,0.21,0.48,3);
        CollisionRule(Apartment34, &buildings);
        Apartment Apartment35(300, 0,-40,30,0.76,0.2,0.43,1);
        CollisionRule(Apartment35, &buildings);
        Apartment Apartment36(295, 0,-0,40,0.34,0.856,0.3,2);
        CollisionRule(Apartment36, &buildings);
        Apartment Apartment37(290, 0,-175,50,0.54,0.62,0.25,2);
        ...
        //Sisi 4
		Apartment Apartment41(50, 0,-250,50,0.87,0.25,0.21,1);
        CollisionRule(Apartment41, &buildings);
        Apartment Apartment42(100, 0,-260,30,0.123,0.234,0.456,2);
		...
		Apartment Apartment43(290, 0,-250,50,0.23,0.42,0.32,1);
        CollisionRule(Apartment43, &buildings);
        Apartment Apartment44(245, 0,-260,30,0.21,0.55,0.21,2);
